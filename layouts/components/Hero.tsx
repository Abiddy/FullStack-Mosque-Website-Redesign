...
const Hero = () => {
  return (
    <div id="home" className="relative min-h-screen w-full flex flex-col">
      ...
      {/* Content */}
      <div className="flex-grow flex items-center justify-center text-gray-900 px-6 md:px-10 lg:px-20 pt-24 md:pt-0 relative z-10">
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="text-left"
          >
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-light tracking-tight mb-6 md:mb-8 text-gray-900 leading-tight">
              Community Based on the Quran and Sunnah
            </h1>
            
            <p className="text-lg md:text-2xl font-light text-gray-600 max-w-2xl mb-8 md:mb-12 italic leading-relaxed">
          ...
          >
            <div className="w-full max-w-[340px] rounded-xl overflow-hidden shadow-2xl bg-white border border-gray-100">
              <iframe 
